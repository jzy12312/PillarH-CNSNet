...
## [Install] 
    ...
    To install PillarH-CNSNet and all its dependencies, please refer to the [mmdetection3D](https://mmdetection3d-zh-cn.readthedocs.io/zh-cn/stable/advanced_guides/datasets/index.html) Chinese documentation. 
